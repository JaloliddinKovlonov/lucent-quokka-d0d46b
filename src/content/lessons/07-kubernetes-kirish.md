...
<iframe src="/kubernetes-diagram.html" style="width:100%;aspect-ratio:16/9;border:1px solid var(--color-neutral-700);border-radius:var(--radius-md);background:#10121c" loading="lazy" title="Kubernetes klaster diagrammasi"></iframe>
